...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=' . $channelId . '&key=AIzaSyANaexgQl6Cq2XC2b52-XBJ4h1BPnWEd_g');
...
// latest video
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyANaexgQl6Cq2XC2b52-XBJ4h1BPnWEd_g&channelId=' . $channelId . '&maxResults=1&order=date&part=snippet';
        ...
        <div class="col-md-5">
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="g-ytsubscribe" data-channelid="UCJHC3VbFsp7kJ2NxPGltwiw" data-layout="default" data-count="default"></div>
            </div>
          </div>
